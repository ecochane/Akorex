...
class DetailsCopy2Widget extends StatefulWidget {
  const DetailsCopy2Widget({
    Key key,
    this.taskdetails,
  }) : super(key: key);
  ...
  @override
  _DetailsCopy2WidgetState createState() => _DetailsCopy2WidgetState();
}

class _DetailsCopy2WidgetState extends State<DetailsCopy2Widget>
