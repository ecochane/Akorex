...
class _EditProfilePageWidgetState extends State<EditProfilePageWidget> {
  ...
  void initState() {
    ...
    textController5 = TextEditingController(text: widget.user.phoneNumber);
    textController6 = TextEditingController(text: widget.user.bio);
  }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Image.network(
                      editProfilePageUsersRecord.profilePicUrl,
                    ),
                  ),
                  Align(
